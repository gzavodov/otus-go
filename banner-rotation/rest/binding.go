...
type Binding struct {
	ucase *usecase.Binding

	endpoint.Handler
}

//Create creates new binding
func (h *Binding) Create(w http.ResponseWriter, r *http.Request) {
	h.LogRequestURL(r)
...
//Read reads binding by ID
func (h *Binding) Read(w http.ResponseWriter, r *http.Request) {
	h.LogRequestURL(r)
...
//Update updates binding
func (h *Binding) Update(w http.ResponseWriter, r *http.Request) {
	h.LogRequestURL(r)
...
//Delete deletes binding by ID
func (h *Binding) Delete(w http.ResponseWriter, r *http.Request) {
	h.LogRequestURL(r)
	...
	if err := h.ucase.DeleteByModel(m); err != nil {
		h.LogError("Repository", err)
		if err = h.WriteResult(w, endpoint.Error{Error: err.Error()}); err != nil {
			h.LogError("Response writing", err)
			http.Error(w, http.StatusText(http.StatusInternalServerError), http.StatusInternalServerError)
